 ...
 *     "form" = {
 *       "default" = "Drupal\form_mode_routing\Form\FormRoutingEntityForm",
...
class FormRoutingEntity extends ConfigEntityBase implements FormRoutingEntityInterface {
  ...
  /**
   * Function to return json data as array.
   *
   * @return mixed
  ...
  /**
   * Function to set array data to json.
   *
   * @param array $array
   *   Array of data to be stored as json string.
   *
   * @return $this
   */
