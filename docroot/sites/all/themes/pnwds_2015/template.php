 ...
 */
function pnwds_2015_js_alter(&$javascript) {
 ...
 */
function pnwds_2015_preprocess_views_view_list(&$vars) {
...
function pnwds_2015_preprocess_views_view_fields(&$vars) {
  if (isset($vars['view']->name)) {
    $function = __FUNCTION__ . '__' . $vars['view']->name . '__' . $vars['view']->current_display;
...
function pnwds_2015_preprocess_panels_pane(&$vars) {
  // get the subtype
 ...
 */
function pnwds_2015_views_pre_render(&$view) {
  if (isset($view->name)) {
 ...
 */
function pnwds_2015_preprocess_node(&$vars) {
  $node = $vars['node'];
 ...
 */
function pnwds_2015_preprocess_user_profile(&$vars) {
 ...
 */
function pnwds_2015_menu_alter(&$items) {
 ...
 *
 */
function pnwds_2015_menu_tree__user_menu($vars) {
 ...
 * - Main LI
 */
function pnwds_2015_menu_link__user_menu($vars) {
 ...
 * - Inner UL
 */
function pnwds_2015_menu_tree__user_menu_inner($vars) {
 ...
 * - Inner LI
 */
function pnwds_2015_menu_link__user_menu_inner($vars) {
  $element = $vars['element'];
  $sub_menu = '';
 ...
 *
 */
function pnwds_2015_menu_tree__main_menu($vars) {
 ...
 * - Main LI
 */
function pnwds_2015_menu_link__main_menu(array $vars) {
  $element = $vars['element'];
  $sub_menu = '';
  $path = current_path();
 ...
 * - Inner UL
 */
function pnwds_2015_menu_tree__main_menu_inner($vars) {
 ...
 * - Inner LI
 */
function pnwds_2015_menu_link__main_menu_inner($vars) {
  $element = $vars['element'];
  $sub_menu = '';
  if ($element['#below']) {
    $sub_menu = drupal_render($element['#below']);
 ...
 *
 */
function pnwds_2015_form_ticket_field_formatter_view_form_alter(&$form, &$form_state, $form_id) {
