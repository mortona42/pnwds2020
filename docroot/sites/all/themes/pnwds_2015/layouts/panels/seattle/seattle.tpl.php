...
<div class="panel-display seattle panel-layout clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>

  <div class="container header clearfix">
    <div class="container-inner header-inner panel-panel-inner">
	    <div class="column-content-region header-top column panel-panel ">
        <div class="column-content-region-inner header-top-inner column-inner panel-panel-inner">
