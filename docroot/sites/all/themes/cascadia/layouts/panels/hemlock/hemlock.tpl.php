...
<div class="hemlock panel-display panel-layout clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="container middle clearfix panel-panel">
    <div class="container-inner middle-inner panel-panel-inner">
